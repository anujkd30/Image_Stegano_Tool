 ...
 */
public class GetMessage extends javax.swing.JFrame {
    ...
    private void initComponents() {
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(coverImageLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)))))
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(181, 181, 181)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(modifyBitsPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(outputTextArea, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(extractTextButton)
                .addGap(23, 23, 23))
        );
    ...
    private void chooseCoverImageButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chooseCoverImageButtonActionPerformed
        fileChose.setDialogTitle("Select an image");
        ImageFileFilter imageFilter = new ImageFileFilter();
        int returnVal = fileChose.showOpenDialog(this);
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            fileopened = fileChose.getSelectedFile();
            ...
            try {
                if (imageFilter.isPNGOrBMPImage(name)) {
                    ...
                    BufferedImage currentImage
                            = imguse.convertImage(baseimage);
                    if (currentImage != null) {
                        baseimage = currentImage;
                    }

                    coverImageColorModel = baseimage.getColorModel();
                    coverImageLabel.setText(name + ", size: "
                            + fileopened.length() / 1024 + " KB, "
                            + baseimage.getWidth() + "X"
                            + baseimage.getHeight());
                } else {
    ...
    private void extractTextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_extractTextButtonActionPerformed
        ...
        String message = lsbEncoding.decodeText(baseimage, bitArray);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GetMessage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
