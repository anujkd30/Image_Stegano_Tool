...
import steganography.Steg_Encoding;
...
public class HideText extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Select Cover Image:");

        chooseCoverImageButton.setText("Select Cover Image");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(secretMessageTextFiled, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void chooseTextFileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chooseTextFileButtonActionPerformed
        chosenfile.setDialogTitle("Choose a plain Text File");
        TextFileFilter filter = new TextFileFilter();
        chosenfile.setFileFilter(filter);
        int returnVal = chosenfile.showOpenDialog(this);
    ...
    private void chooseCoverImageButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chooseCoverImageButtonActionPerformed
        chosenfile.setDialogTitle("Select an image");
        ImageFileFilter imageFilter = new ImageFileFilter();
        chosenfile.setFileFilter(imageFilter);
        int returnVal = chosenfile.showOpenDialog(this);
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            fileopened = chosenfile.getSelectedFile();
            ...
            try {
                if (imageFilter.isPNGOrBMPImage(name)) {
                    ...
                    BufferedImage currentImage
                            = imguse.convertImage(baseimg);
                    if (currentImage != null) {
                        baseimg = currentImage;
                    }
                    
                    coverImageColorModel = baseimg.getColorModel();
    ...
    private void hideTextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hideTextButtonActionPerformed
        ...
        Steg_Encoding lsbEncoding = new Steg_Encoding();
        ...
        lsbEncoding.encodeText(baseimg, secretMessage, bitArray);
        saveImage();
    ...
    private void saveImage() {
        ...
        chosenfile.setDialogTitle("Choose a location");
        ...
        chosenfile.setSelectedFile(file);
        int returnVal = chosenfile.showSaveDialog(this);
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            file = chosenfile.getSelectedFile();
            String name = file.getName();
            if (imguse.isImage(name)) {
                imguse.saveImage(baseimg, file);
            } else {
